...
<div class="dev-wrap">
    <div class="dev-icon"><i class="bi bi-building"></i></div>
    <h3>Hotel Dashboard</h3>
    <p class="dev-sub">This page is currently under development.</p>
    <p class="dev-msg">We're working hard to bring you a complete overview of your hotel operations — occupancy, bookings, revenue, and more, all in one place.</p>
